...
#include "admin.h"
#include "student.h"
#include "Programme_Coordinator.h"
#include "programleader.h"
...
int main(void){
   ...
   login_data_file = fopen("login_data_file.txt","r");
...
void student_menu(char studentCode[]) {
   ...
   studnet_data_file = fopen("students.txt","r");
   extra_activity_file = fopen("extra_activity.txt","r");
...
void Programme_Leader_menu()
{
    ...
    readStudentDataFromFile(students, &numStudents, "students.txt");

    // Read extra activity data from the file
    readStudentDataFromFile(students, &numStudents, "extra_activity.txt");
